            ...
            <div className="start">
                ...
                <div className="test">
                    ...
                    <form method="post" action="/send_form.php" id="contact_form">
                        <div className="firstTwo"><label htmlFor="name" className="formFieldText">JAK SIĘ NAZYWASZ?</label>
                        ...
                        <div className="opis"><label htmlFor="desc" className="formFieldText">OPIS</label></div>
                        <div className="lastOne"><textarea name="desc" id="desc" className="formField"></textarea></div><br></br>
